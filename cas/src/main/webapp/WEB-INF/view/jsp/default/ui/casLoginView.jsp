  ...
  <div class="box fl-panel" id="login">
			<form:form method="post" id="fm1" cssClass="fm-v clearfix" commandName="${commandName}" htmlEscape="true">
                ...
                <!-- <spring:message code="screen.welcome.welcome" /> -->
                    ...
                    <div class="row btn-row">
                        <%
                            org.springframework.context.ApplicationContext context = org.springframework.web.servlet.support.RequestContextUtils.getWebApplicationContext(request);
                            org.jasig.cas.adaptors.x509.authentication.handler.support.X509CredentialsEstEidAuthenticationHandler estEidAuthenticationHandler = (org.jasig.cas.adaptors.x509.authentication.handler.support.X509CredentialsEstEidAuthenticationHandler) context.getBean("estEidAuthenticationHandler");
                        %>
                        <c:set var='query' value='<%=request.getQueryString()%>' />
                        <c:set var="xquery" value="${fn:escapeXml(query)}" />
                        <a href="<%=estEidAuthenticationHandler.getUrl()%><%=request.getContextPath()%>/login?${xquery}">
