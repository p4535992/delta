...
<%@ taglib uri="/WEB-INF/repo.tld" prefix="r"%>
   ...
   <a:panel id="categories-breadcrumb" styleClass="breadcrumb">
         ...
         <a:richList id="categories-list"  viewMode="#{DialogManager.bean.viewMode}" pageSize="15" rowStyleClass="recordSetRow" altRowStyleClass="recordSetRowAlt" width="100%"
            ...
            <a:column primary="true" style="padding:2px;text-align:left;vertical-align:top;">
               ...
               <f:facet name="large-icon">
                  <a:actionLink value="#{r.name}" image="/images/icons/category.gif" actionListener="#{DialogManager.bean.clickCategory}" showLink="false" padding="10">
