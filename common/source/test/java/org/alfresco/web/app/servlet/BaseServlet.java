...
public abstract class BaseServlet extends HttpServlet
{
   ...
   {
     logger.debug("servletAuthenticate() - Expecting that authentication is already done using authentication filter");
     return null; // Expecting that authentication is already done using authentication filter
     //@formatter:off
     /*
