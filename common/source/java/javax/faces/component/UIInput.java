        ...
        implements EditableValueHolder
{
    ...
    private List<Validator> _validatorList = null;
    ...
    protected void validateValue(FacesContext context,Object convertedValue)
    {
		...
		//Call instances of MandatoryIfValidator even if value is left empty
        if (empty && hasMandatoryIfValidators())
        {
    ...
    private boolean hasMandatoryIfValidators() {
        for (Validator validator : getValidators()) {
            if (validator instanceof MandatoryIfValidator) {
                return true;
            }
        }
        return false;
    ...
    public void restoreState(FacesContext context, Object state)
    {
        ...
        _validatorList = (List<Validator>)restoreAttachedState(context, values[8]);
    }
