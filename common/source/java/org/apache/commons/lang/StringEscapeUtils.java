...
public class StringEscapeUtils {
    ...
    /**
     * <p>
     * Unescapes any Java literals found in the <code>String</code>. For example, it will turn a sequence of <code>'\'</code> and <code>'n'</code> into a newline character, unless
     ...
     * </p>
     * <p>
     * Supports all known HTML 4.0 entities, including funky accents. Note that the commonly used apostrophe escape character (&amp;apos;) is not a legal entity and so is not
     * supported).
     * </p>
     *
     ...
     * </p>
     * <p>
     * At present, this method only turns single-quotes into doubled single-quotes (<code>"McHale's Navy"</code> => <code>"McHale''s Navy"</code>). It does not handle the cases of
    ...
    /**
     * <p>
     * Returns a <code>String</code> value for a CSV column enclosed in double quotes, if required.
     * </p>
     * <p>
    ...
    /**
     * <p>
     * Writes a <code>String</code> value for a CSV column enclosed in double quotes, if required.
     * </p>
     * <p>
