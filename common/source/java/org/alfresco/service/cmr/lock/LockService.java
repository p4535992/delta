...
public interface LockService
{
   ...
   /**
    * Places a {@link org.alfresco.repo.lock.mem.Lifetime#PERSISTENT persistent} lock on a node.
    * <p>
    * The lock prevents any other user or process from comitting updates 
    * to the node until the lock is released.  
    * <p>
    ...
    * 
    * @see org.alfresco.service.cmr.lock.LockService#getLockStatus(org.alfresco.service.cmr.repository.NodeRef, org.alfresco.service.cmr.repository.NodeRef)
    * 
    ...
    * use {@link #getLockStatus(org.alfresco.service.cmr.repository.NodeRef)} and other LockService methods for this purpose.
    * <p>
