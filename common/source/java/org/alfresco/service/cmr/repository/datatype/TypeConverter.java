...
public class TypeConverter
{
    ...
    public final <T> T convert(Class<T> c, Object value)
    {
        ...
        if(value instanceof String && c.isEnum()) {
            return (T) getEnumValue((String)value, (Class<? extends Enum>) c);
        }
        
        if(value instanceof Enum && c == String.class) {
    ...
    private Object getEnumValue(String strEnumValue, Class<? extends Enum> enumType) {
        @SuppressWarnings("unchecked")
        Object tmp = getEnumFromValue(enumType, strEnumValue);
        return tmp;
    }

    private static <E extends Enum<E>> E getEnumFromValue(Class<E> enumType, String value) {
        try {
            return StringUtils.isBlank(value) ? null : Enum.valueOf(enumType, value);
        } catch (IllegalArgumentException e) {
            FacesMessage facesMessage = MessageUtil.getFacesMessage(new MessageDataImpl("", value));
