...
public class ViewParser implements Parser
{
    ...
    public void parse(Reader viewReader, Importer importer)
    {
        try
        {
            ...
            try
            {
                parseDocument(xpp, parserContext);
            }
            catch(Exception e)
            {
     ...
     * @throws IOException
     */
    protected void processStartElement(XmlPullParser xpp, ParserContext parserContext)
     ...
     * @throws IOException
     */
    protected void processRoot(XmlPullParser xpp, ParserContext parserContext)
        throws XmlPullParserException, IOException
    {
     ...
     * @param contextStack
     */
    protected void processEndElement(XmlPullParser xpp, ParserContext parserContext)
    {
     ...
     * @return
     */
    protected QName getName(XmlPullParser xpp)
    {
