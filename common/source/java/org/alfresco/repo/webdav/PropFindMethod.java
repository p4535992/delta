...
public class PropFindMethod extends WebDAVMethod
{
    ...
    protected void executeImpl() throws WebDAVServerException, Exception
    {
        ...
        try
        {
            ...
            pathNodeInfo = getDAVHelper().getNodeForPath(getRootNodeRef(), m_strPath, null); // FIXME Do we need to pass "webdav" here?
        }
        ...
        // TODO Currently HiddenAspect isn't used
        ...
        for (WebDAVProperty property : m_properties)
        {
            ...
            if (WebDAV.DEFAULT_NAMESPACE_URI.equals(propNamespaceUri))
            {
                ...
                else if (propName.equals(WebDAV.XML_GET_ETAG) && !isDir)
                {
                    ...
                    xml.write(getDAVHelper().makeETag(nodeInfo.getNodeRef()));
