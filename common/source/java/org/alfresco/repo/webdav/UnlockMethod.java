...
{
    protected String m_strLockToken = null;
     ...
     * 
     * @throws org.alfresco.repo.webdav.WebDAVServerException
     */
            ...
            if (currentUser.equals(lockInfo.getOwner()))
            {
            	try
                {
                    ...
                    if (BeanHelper.getFileService().isFileGenerated(lockNodeInfo.getNodeRef())) {
                        ...
                        if (docRef != null) {
                            getDAVLockService().unlock(docRef);
                        }
                    }
                }
    ...
    protected void removeNoContentAspect(NodeRef nodeRef)
    {
