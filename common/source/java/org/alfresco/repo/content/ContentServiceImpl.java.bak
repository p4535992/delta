...
public class ContentServiceImpl implements ContentService, ApplicationContextAware
{
     ...
     * Policies delegates
     */
    ClassPolicyDelegate<OnContentUpdatePolicy> onContentUpdateDelegate;
    ClassPolicyDelegate<OnContentPropertyUpdatePolicy> onContentPropertyUpdateDelegate;
    ClassPolicyDelegate<OnContentReadPolicy> onContentReadDelegate;
    ...
    public ContentWriter getWriter(NodeRef nodeRef, QName propertyQName, boolean update) {
        ...
        public ContentWriter getWriter(NodeRef nodeRef, QName propertyQName, boolean update, String CURRENT_USER)
    {
        ...
        if (update)
        {
            ...
            WriteStreamListener listener = new WriteStreamListener(nodeService, nodeRef, propertyQName, writer, CURRENT_USER);
    ...
    /**
     * @see ContentTransformerRegistry
    ...
    /**
     * @see ContentService#getTransformer(String, String, TransformationOptions)
     */
    ...
    /**
     * @see ContentService#getImageTransformer()
     */
    ...
    /**
     * @see ContentService#isTransformable(ContentReader, ContentWriter, TransformationOptions)
     */
    ...
    private static class WriteStreamListener implements ContentStreamListener
    {
                ...
                String CURRENT_USER)
        {
            ...
            this.propertyQName = propertyQName;
            this.writer = writer;
            logger.trace("WriteStreamListener(): SET CURRENT_USER: " + CURRENT_USER);
        ...
        {
            logger.trace("contentStreamClosed()... CURRENT_USER: " + CURRENT_USER);
            try
            {
                ...
                if (nodeRef.getStoreRef().getProtocol().equals(StoreRef.PROTOCOL_AVM))
                {
                    logger.trace("contentStreamClosed(): nodeService.setProperty(): CURRENT_USER: " + CURRENT_USER);
                    nodeService.setProperty(nodeRef, ContentModel.PROP_CONTENT, contentData, CURRENT_USER);
                }
                else
                {
                    logger.trace("contentStreamClosed(): nodeService.setProperty(): CURRENT_USER: " + CURRENT_USER);
