...
public abstract class AbstractReindexComponent implements IndexRecovery
{
    ...
    /**
     * Set the thread pool to use when doing asynchronous reindexing. Use <tt>null</tt> to have the calling thread do the indexing.
     * 
    ...
    public final void reindex()
    {
        ...
        PropertyCheck.mandatory(this, "ftsIndexer", getFtsIndexer());
        PropertyCheck.mandatory(this, "indexer", indexer);
        PropertyCheck.mandatory(this, "searcher", searcher);
        PropertyCheck.mandatory(this, "nodeService", nodeService);
        PropertyCheck.mandatory(this, "nodeDaoService", nodeDaoService);
        PropertyCheck.mandatory(this, "transactionComponent", transactionService);
    ...
    private class ReindexWorkerRunnable extends TransactionListenerAdapter implements Runnable, ReindexNodeCallback
    {
        ...
        {
            lastIndexedTimestamp = System.nanoTime();
        }
     ...
     */
    private final LinkedBlockingQueue<ReindexWorkerRunnable> reindexThreadQueue = new LinkedBlockingQueue<ReindexWorkerRunnable>();
    private final ReentrantReadWriteLock reindexThreadLock = new ReentrantReadWriteLock(true);
    ...
    protected FullTextSearchIndexer getFtsIndexer() {
        if (ftsIndexer == null) {
            ftsIndexer = BeanHelper.getSpringBean(FullTextSearchIndexer.class, "LuceneFullTextSearchIndexer");
        }
        return ftsIndexer;
    }
}