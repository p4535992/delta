...
public class SearcherComponent extends AbstractSearcherComponent
{
    ...
    {
        SearchService searcher = getIndexerAndSearcherFactory().getSearcher(store, true);
    ...
    public ResultSet query(SearchParameters searchParameters)
    {
        ...
        SearchService searcher = getIndexerAndSearcherFactory().getSearcher(storeRef, !searchParameters.excludeDataInTheCurrentTransaction());
    ...
    {
        SearchService searcher = getIndexerAndSearcherFactory().getSearcher(nodeRef.getStoreRef(), true);
    ...
    {
        SearchService searcher = getIndexerAndSearcherFactory().getSearcher(contextNodeRef.getStoreRef(), true);
    ...
    private IndexerAndSearcher getIndexerAndSearcherFactory() {
        if (indexerAndSearcherFactory == null) {
            indexerAndSearcherFactory = BeanHelper.getSpringBean(IndexerAndSearcher.class, "indexerAndSearcherFactory");
        }
