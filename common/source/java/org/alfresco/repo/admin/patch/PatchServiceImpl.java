...
public class PatchServiceImpl implements PatchService
{
    ...
    public DescriptorService getDescriptorService() {
        if (descriptorService == null) {
            descriptorService = BeanHelper.getDescriptorService();
        }
    ...
    public boolean validatePatches()
    {
        ...
        int serverSchemaVersion = getDescriptorService().getServerDescriptor().getSchema();
    ...
    private AppliedPatch applyPatch(Patch patch)
    {
        ...
        Descriptor repoDescriptor = getDescriptorService().getInstalledRepositoryDescriptor();
