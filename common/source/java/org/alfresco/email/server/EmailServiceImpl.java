...
public class EmailServiceImpl implements EmailService
{
    ...
    protected static final String ERR_INBOUND_EMAIL_DISABLED = "email.server.err.inbound_mail_disabled";
    protected static final String ERR_INVALID_SUBJECT = "email.server.err.invalid_subject";
    protected static final String ERR_ACCESS_DENIED = "email.server.err.access_denied";
    ...
    protected boolean emailInboundEnabled;
     ...
     */
    protected EmailMessageHandler getMessageHandler(NodeRef nodeRef)
    {
     ...
     */
    protected NodeRef getTargetNode(String recipient)
    {
