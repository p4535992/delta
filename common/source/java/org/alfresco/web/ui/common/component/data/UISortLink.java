...
public class UISortLink extends UICommand
{
   ...
   public void encodeBegin(FacesContext context) throws IOException
   {
      ...
      if (bPreviouslySorted == true)
      {
         ...
         {
            buf.append(" ")
               .append(Utils.buildImageTag(context, WebResources.IMAGE_SORTUP, 16, 16, null));
         }
         else
         {
            buf.append(" ")
               .append(Utils.buildImageTag(context, WebResources.IMAGE_SORTDOWN, 16, 16, null));
         }
      }
      else
      {
         //We don't want to render the image if column isn't sorted 
         //buf.append(" ")
