...
public class RichListTag extends BaseComponentTag
{
   ...
   protected void setProperties(UIComponent component)
   {
      ...
      setStringProperty(component, "doPermissionCheck", this.doPermissionCheck);
   }
   ...
   /**
    * Set the doPermissionCheck flag. StringValue of the permission to check 
    *
    * @param doPermCheck     the permission check
    */
   public void setDoPermissionCheck(String doPermCheck)
   {
      this.doPermissionCheck = doPermCheck;
   }
   ...
   private String doPermissionCheck;
}
=======
/*
 * Copyright (C) 2005-2007 Alfresco Software Limited.
