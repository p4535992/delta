   ...
   public void encodeBegin(FacesContext context) throws IOException
   {
      ...
      if (items.size() != 0)
      {
         ...
         for (int i=0; i<items.size(); i++)
         {
            ...
            out.write("<li class='clipboard-item'>");
            // output the icon indicating whether the node was obtained by cut or copy
            ...
            // Maybe we'll need to output a nifty icon, so I'll leave it here at the moment.
            /*
            if (isFolder)
            {
            ...
            */
            ...
            // output actions
            out.write("<span class='clipboard-item-actions'>");
            ...
            // end actions and the list element
            out.write("</span></li>");
         }
         
         // output general actions if any clipboard items are present
         out.write("<li class='clipboard-general'>");
