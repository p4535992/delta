...
{  
   ...
   protected String childrenCountUrl;
   ...
   public static class TreeNode implements Serializable
   {
       ...
       */
      public TreeNode(String nodeRef, String name, String icon, int childrenCount)
      {
      ...
      public String toString()
      {
         ...
         buffer.append(", childrenCount=").append(this.childrenCount);
         if (this.parent != null)
         {
