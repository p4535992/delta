      ...
      if (items != null && items.size() > 0) {
         ...
         for (int i=0; i<items.size(); i++)
         {
            ...
            */
            ...
            // output actions
            out.write("<span class='shortcut-item-remove'>");
            out.write(buildActionLink(ACTION_REMOVE_ITEM, i, Application.getMessage(context, MSG_REMOVE_ITEM), WebResources.IMAGE_REMOVE_X));
            out.write("</span>");
