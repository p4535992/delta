...
public class LoginBean implements Serializable
{
   ...
   /**
    * @return true to display language selection if there is more than one language, false to 
    */
   public boolean isMultipleLanguageSelect()
   {
      return (this.preferences.getLanguages().length > 1);
   }
