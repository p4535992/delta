...
public final class Repository
{
   ...
   public static void setStoreRef(StoreRef storeRef) {
       ParameterCheck.mandatory("storeRef", storeRef);
       if (Repository.storeRef != null && !Repository.storeRef.equals(storeRef)) {
           throw new IllegalStateException("Can't change storeRef to " + storeRef + ", because storeRef is already set to " + Repository.storeRef);
       }
       Repository.storeRef = storeRef;
   }
