...
public enum Parameters {
    ...
    // MaaIS
    MAAIS_RENEW_SESSIONS_PERIOD("maaisRenewSessionsPeriod"),
    MAAIS_NOTIFY_ASSOC_RETRY_PERIOD("maaisNotifyAssocRetryPeriod"),
    MAAIS_OUTGOING_LETTER_SIGNER_NAME("maaisOutgoingLetterSignerName"),
    MAAIS_RENEW_CASES_TIME("maaisRenewCasesTime"),
    MAAIS_DOC_TYPE_GROUP_NAME("maaisDocTypeGroupName"),
