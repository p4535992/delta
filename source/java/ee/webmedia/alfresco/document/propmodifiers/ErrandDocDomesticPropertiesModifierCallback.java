...
public class ErrandDocDomesticPropertiesModifierCallback extends AbstractDocChildCreator {
    ...
    public QName getAspectName() {
        return DocumentSpecificModel.Aspects.ERRAND_APPLICATION_DOMESTIC_V2;
    }
    ...
    protected List<DocChildAssocInfoHolder> getDocChildAssocInfo(Node docNode) {
        final DocChildAssocInfoHolder doc2Applicant = new DocChildAssocInfoHolder(
                ...
                DocumentSpecificModel.Types.ERRAND_APPLICATION_DOMESTIC_APPLICANT_TYPE_V2,
                getMetadataBlock().setApplicantName(AuthenticationUtil.getRunAsUser(), new HashMap<String, Object>(),
                        new HashSet<QName>(Arrays.asList(DocumentSpecificModel.Types.ERRAND_APPLICATION_DOMESTIC_APPLICANT_TYPE_V2))));
        final DocChildAssocInfoHolder applicant2Errand = new DocChildAssocInfoHolder(
                DocumentSpecificModel.Assocs.ERRAND_DOMESTIC_V2,
                DocumentSpecificModel.Types.ERRANDS_DOMESTIC_TYPE_V2);
