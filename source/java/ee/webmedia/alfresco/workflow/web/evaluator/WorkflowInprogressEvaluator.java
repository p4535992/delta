...
public class WorkflowInprogressEvaluator extends AbstractFullAccessEvaluator {
    ...
    public boolean evaluate() {
        ...
        return compoundWorkflow != null && WorkflowUtil.isStatus(compoundWorkflow, Status.IN_PROGRESS) && hasFullAccess(resource)
                && (!resource.isIndependentWorkflow() || isOwnerOrDocManager(resource))
