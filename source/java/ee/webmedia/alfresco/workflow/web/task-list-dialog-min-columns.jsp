...
<%@ page isELIgnored="false"%>
      ...
      <a:column id="col6" styleClass="#{r.task.cssStyleClass}" style="width: 25%;">
         ...
         <a:actionLink id="col6-text" value="#{r.document.docName}" action="#{DocumentDialog.action}" tooltip="#{r.document.docName}" actionListener="#{DocumentDialog.open}" styleClass="condence20-">
            <f:param name="nodeRef" value="#{r.document.node.nodeRef}" />
         </a:actionLink>
      </a:column>
