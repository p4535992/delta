...
<%@ page isELIgnored="false"%>
      ...
      <a:column id="resolution" primary="true" styleClass="#{r.task.cssStyleClass}" style="width: 15%;">
         ...
         <a:actionLink id="resolution-text" value="#{r.task.node.properties['{temp}resolution']}" action="#{DocumentDialog.action}" tooltip="#{r.task.node.properties['{temp}resolution']}" actionListener="#{DocumentDialog.open}" styleClass="no-underline" >
            <f:param name="nodeRef" value="#{r.document.node.nodeRef}" />
         </a:actionLink>
      </a:column>
      ...
      <a:column id="creatorName" primary="true" styleClass="#{r.task.cssStyleClass}" style="width: 10%;">
         ...
         <a:actionLink id="creatorName-text" value="#{r.task.creatorName}" action="#{DocumentDialog.action}" tooltip="#{r.task.creatorName}" actionListener="#{DocumentDialog.open}" styleClass="no-underline" >
            <f:param name="nodeRef" value="#{r.document.node.nodeRef}" />
         </a:actionLink>
      </a:column>
      ...
      <a:column id="col1" primary="true" styleClass="#{r.task.cssStyleClass}" style="width: 10%;">
         ...
         <a:actionLink id="col1-text" value="#{r.document.regNumber}" action="#{DocumentDialog.action}" tooltip="#{r.document.regNumber}" actionListener="#{DocumentDialog.open}" styleClass="no-underline" >
            <f:param name="nodeRef" value="#{r.document.node.nodeRef}" />
         </a:actionLink>
      </a:column>
      ...
      <a:column id="col2" primary="true" styleClass="#{r.task.cssStyleClass}" style="width: 10%;">
         ...
         <a:actionLink id="col2-text" value="#{r.document.regDateTimeStr}" action="#{DocumentDialog.action}" tooltip="#{r.document.regDateTimeStr}" actionListener="#{DocumentDialog.open}" styleClass="no-underline" >
            <f:param name="nodeRef" value="#{r.document.node.nodeRef}" />
         </a:actionLink>
      </a:column>
      ...
      <a:column id="col4" primary="true" styleClass="#{r.task.cssStyleClass}" style="width: 10%;">
         ...
         <a:actionLink id="col4-text" value="#{r.document.sender}" action="#{DocumentDialog.action}" tooltip="#{r.document.sender}" actionListener="#{DocumentDialog.open}" styleClass="no-underline condence20-" >
            <f:param name="nodeRef" value="#{r.document.node.nodeRef}" />
         </a:actionLink>
      </a:column>
      ...
      <a:column id="col6" styleClass="#{r.task.cssStyleClass}" style="width: 15%;">
         ...
         <a:actionLink id="col6-text" value="#{r.document.docName}" action="#{DocumentDialog.action}" tooltip="#{r.document.docName}"
      ...
      <a:column id="col7" primary="true" styleClass="#{r.task.cssStyleClass}" style="width: 10%;">
         ...
         <a:actionLink id="col7-text" value="#{r.document.dueDateStr}" action="#{DocumentDialog.action}" tooltip="#{r.document.dueDateStr}" actionListener="#{DocumentDialog.open}" styleClass="no-underline" >
            <f:param name="nodeRef" value="#{r.document.node.nodeRef}" />
         </a:actionLink>
      </a:column>
      ...
      <a:column id="col3" primary="true" styleClass="#{r.task.cssStyleClass}" style="width: 10%;">
         ...
         <a:actionLink id="col3-text" value="#{r.document.documentTypeName}" action="#{DocumentDialog.action}" tooltip="#{r.document.documentTypeName}" actionListener="#{DocumentDialog.open}" styleClass="no-underline" >
            <f:param name="nodeRef" value="#{r.document.node.nodeRef}" />
         </a:actionLink>
     </a:column>
