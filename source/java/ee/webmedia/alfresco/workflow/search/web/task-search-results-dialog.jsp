...
<a:panel id="task-panel" styleClass="panel-100 with-pager" label="#{msg.task_search_results}" progressive="true">
   ...
   <a:richList id="taskList" styleClass="duplicate-header" viewMode="details" pageSize="#{BrowseBean.pageSizeContent}" rowStyleClass="recordSetRow" altRowStyleClass="recordSetRowAlt"
      ...
      <a:column id="col1" primary="true" styleClass="#{r.cssStyleClass}" rendered="#{workflowConstantsBean.documentWorkflowEnabled}" >
         ...
         <a:actionLink id="col1-txt" value="#{r.regNum}" action="#{DocumentDialog.action}" tooltip="#{r.regNum}" showLink="false" actionListener="#{DocumentDialog.open}" styleClass="no-underline" rendered="#{!r.linkedReviewTask && r.documentWorkflow}" >
            <f:param name="nodeRef" value="#{r.documentNodeRef}" />
         </a:actionLink>
         <a:actionLink id="col1-txt1" value="#{r.regNum}" action="dialog:compoundWorkflowDialog" tooltip="#{r.regNum}" showLink="false" actionListener="#{CompoundWorkflowDialog.setupWorkflowFromList}" styleClass="no-underline" rendered="#{r.independentWorkflow || r.caseFileWorkflow}" >
            <f:param name="nodeRef" value="#{r.compoundWorkflowNodeRef}" />
         </a:actionLink>         
      ...
      <a:column id="col2" primary="true" styleClass="#{r.cssStyleClass}" rendered="#{workflowConstantsBean.documentWorkflowEnabled}" >
         <f:facet name="header">
            <a:sortLink id="col2-header" label="#{msg.task_search_result_regDate}" value="regDate" styleClass="header" />
         </f:facet>
         <a:actionLink id="col2-txt" value="#{r.regDateStr}" action="#{DocumentDialog.action}" tooltip="#{r.regDateStr}" showLink="false" actionListener="#{DocumentDialog.open}" styleClass="no-underline" rendered="#{!r.linkedReviewTask && r.documentWorkflow}" >
            <f:param name="nodeRef" value="#{r.documentNodeRef}" />
         </a:actionLink>
         <a:actionLink id="col2-txt1" value="#{r.regDateStr}" action="dialog:compoundWorkflowDialog" tooltip="#{r.regDateStr}" showLink="false" actionListener="#{CompoundWorkflowDialog.setupWorkflowFromList}" styleClass="no-underline" rendered="#{r.independentWorkflow || r.caseFileWorkflow}" >
            <f:param name="nodeRef" value="#{r.compoundWorkflowNodeRef}" />
         </a:actionLink>         
      ...
      <a:column id="col6" primary="true" styleClass="#{r.cssStyleClass}" >
         <f:facet name="header">
          ...
          <a:actionLink id="col6-txt" value="#{r.startedDateStr}" action="#{DocumentDialog.action}" tooltip="#{r.startedDateStr}" showLink="false" actionListener="#{DocumentDialog.open}" styleClass="no-underline" rendered="#{!r.linkedReviewTask && r.documentWorkflow}" >
            <f:param name="nodeRef" value="#{r.documentNodeRef}" />
         </a:actionLink>
          <a:actionLink id="col6-txt1" value="#{r.startedDateStr}" action="dialog:compoundWorkflowDialog" tooltip="#{r.startedDateStr}" showLink="false" actionListener="#{CompoundWorkflowDialog.setupWorkflowFromList}" styleClass="no-underline" rendered="#{r.independentWorkflow || r.caseFileWorkflow}" >
            <f:param name="nodeRef" value="#{r.compoundWorkflowNodeRef}" />
         </a:actionLink>         
      ...
      <a:column id="col7" primary="true" styleClass="#{r.cssStyleClass}" >
         ...
         <a:actionLink id="col7-txt" value="#{r.ownerName}" action="#{DocumentDialog.action}" tooltip="#{r.ownerName}" showLink="false" actionListener="#{DocumentDialog.open}" styleClass="no-underline" rendered="#{!r.linkedReviewTask && r.documentWorkflow}" >
            <f:param name="nodeRef" value="#{r.documentNodeRef}" />
         </a:actionLink>
         <a:actionLink id="col7-txt1" value="#{r.ownerName}" action="dialog:compoundWorkflowDialog" tooltip="#{r.ownerName}" showLink="false" actionListener="#{CompoundWorkflowDialog.setupWorkflowFromList}" styleClass="no-underline" rendered="#{r.independentWorkflow || r.caseFileWorkflow}" >
            <f:param name="nodeRef" value="#{r.compoundWorkflowNodeRef}" />
         </a:actionLink>         
      ...
      <a:column id="col10" primary="true" styleClass="#{r.cssStyleClass}" >
         ...
         <a:actionLink id="col10-txt" value="#{r.taskTypeText}" action="#{DocumentDialog.action}" tooltip="#{r.taskTypeText}" showLink="false" actionListener="#{DocumentDialog.open}" styleClass="no-underline" rendered="#{!r.linkedReviewTask && r.documentWorkflow}" >
            <f:param name="nodeRef" value="#{r.documentNodeRef}" />
         </a:actionLink>
         <a:actionLink id="col10-txt1" value="#{r.taskTypeText}" action="dialog:compoundWorkflowDialog" tooltip="#{r.taskTypeText}" showLink="false" actionListener="#{CompoundWorkflowDialog.setupWorkflowFromList}" styleClass="no-underline" rendered="#{r.independentWorkflow || r.caseFileWorkflow}" >
            <f:param name="nodeRef" value="#{r.compoundWorkflowNodeRef}" />
         </a:actionLink>         
      ...
      <a:column id="col16" primary="true" styleClass="#{r.cssStyleClass}" >
         ...
         <a:actionLink id="col16-txt" value="#{r.resolution}" action="#{DocumentDialog.action}" tooltip="#{r.resolution}" showLink="false" actionListener="#{DocumentDialog.open}" styleClass="tooltip condence20- no-underline" rendered="#{!r.linkedReviewTask && r.documentWorkflow}" >
            <f:param name="nodeRef" value="#{r.documentNodeRef}" />
         </a:actionLink>
         <a:actionLink id="col16-txt1" value="#{r.resolution}" action="dialog:compoundWorkflowDialog" tooltip="#{r.resolution}" showLink="false" actionListener="#{CompoundWorkflowDialog.setupWorkflowFromList}" styleClass="tooltip condence20- no-underline"  rendered="#{r.independentWorkflow || r.caseFileWorkflow}" >
            <f:param name="nodeRef" value="#{r.compoundWorkflowNodeRef}" />
         </a:actionLink>         
      ...
      <a:column id="col19" primary="true" styleClass="#{r.cssStyleClass}" >
         <f:facet name="header">
          ...
          <a:actionLink id="col19-txt" value="#{r.compoundWorkflowType}" action="#{DocumentDialog.action}" tooltip="#{r.compoundWorkflowType}" showLink="false" actionListener="#{DocumentDialog.open}" styleClass="no-underline" rendered="#{!r.linkedReviewTask && r.documentWorkflow}" >
            <f:param name="nodeRef" value="#{r.documentNodeRef}" />
         </a:actionLink>
          <a:actionLink id="col19-txt1" value="#{r.compoundWorkflowType}" action="dialog:compoundWorkflowDialog" tooltip="#{r.compoundWorkflowType}" showLink="false" actionListener="#{CompoundWorkflowDialog.setupWorkflowFromList}" styleClass="no-underline" rendered="#{r.independentWorkflow || r.caseFileWorkflow}" >
            <f:param name="nodeRef" value="#{r.compoundWorkflowNodeRef}" />
         </a:actionLink>         
      </a:column>
      ...
      <a:column id="col19_1" primary="true" styleClass="#{r.cssStyleClass}" >
         <f:facet name="header">
          ...
          <a:actionLink id="col19_1-txt" value="#{r.compoundWorkflowTitle}" action="#{DocumentDialog.action}" tooltip="#{r.compoundWorkflowTitle}" showLink="false" actionListener="#{DocumentDialog.open}" styleClass="no-underline" rendered="#{!r.linkedReviewTask && r.documentWorkflow}" >
            <f:param name="nodeRef" value="#{r.documentNodeRef}" />
         </a:actionLink>
          <a:actionLink id="col19_1-txt1" value="#{r.compoundWorkflowTitle}" action="dialog:compoundWorkflowDialog" tooltip="#{r.compoundWorkflowTitle}" showLink="false" actionListener="#{CompoundWorkflowDialog.setupWorkflowFromList}" styleClass="no-underline" rendered="#{r.independentWorkflow || r.caseFileWorkflow}" >
            <f:param name="nodeRef" value="#{r.compoundWorkflowNodeRef}" />
         </a:actionLink>         
      </a:column>
      ...
      <a:column id="col20" primary="true" styleClass="#{r.cssStyleClass}" >
         <f:facet name="header">
          ...
          <a:actionLink id="col20-txt" value="#{r.compoundWorkflowOwnerName}" action="#{DocumentDialog.action}" tooltip="#{r.compoundWorkflowOwnerName}" showLink="false" actionListener="#{DocumentDialog.open}" styleClass="no-underline" rendered="#{!r.linkedReviewTask && r.documentWorkflow}" >
            <f:param name="nodeRef" value="#{r.documentNodeRef}" />
         </a:actionLink>
          <a:actionLink id="col20-txt1" value="#{r.compoundWorkflowOwnerName}" action="dialog:compoundWorkflowDialog" tooltip="#{r.compoundWorkflowOwnerName}" showLink="false" actionListener="#{CompoundWorkflowDialog.setupWorkflowFromList}" styleClass="no-underline" rendered="#{r.independentWorkflow || r.caseFileWorkflow}" >
            <f:param name="nodeRef" value="#{r.compoundWorkflowNodeRef}" />
         </a:actionLink>         
      </a:column>
      ...
      <a:column id="col27" primary="true" styleClass="#{r.cssStyleClass}" >
         <f:facet name="header">
          ...
          <a:actionLink id="col27-txt" value="#{r.compoundWorkflowStatus}" action="#{DocumentDialog.action}" tooltip="#{r.compoundWorkflowStatus}" showLink="false" actionListener="#{DocumentDialog.open}" styleClass="no-underline" rendered="#{!r.linkedReviewTask && r.documentWorkflow}" >
            <f:param name="nodeRef" value="#{r.documentNodeRef}" />
         </a:actionLink>
          <a:actionLink id="col27-txt1" value="#{r.compoundWorkflowStatus}" action="dialog:compoundWorkflowDialog" tooltip="#{r.compoundWorkflowStatus}" showLink="false" actionListener="#{CompoundWorkflowDialog.setupWorkflowFromList}" styleClass="no-underline" rendered="#{r.independentWorkflow || r.caseFileWorkflow}" >
            <f:param name="nodeRef" value="#{r.compoundWorkflowNodeRef}" />
         </a:actionLink>         
      </a:column>
      ...
      <a:column id="col28" primary="true" styleClass="#{r.cssStyleClass}" >
         <f:facet name="header">
          ...
          <a:actionLink id="col28-txt" value="#{r.compoundWorkflowDocumentCount}" action="#{DocumentDialog.action}" tooltip="#{r.compoundWorkflowDocumentCount}" showLink="false" actionListener="#{DocumentDialog.open}" styleClass="no-underline" rendered="#{!r.linkedReviewTask && r.documentWorkflow}" >
            <f:param name="nodeRef" value="#{r.documentNodeRef}" />
         </a:actionLink>
