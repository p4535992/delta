...
public class CanArchiveVolumeEvaluator extends BaseActionEvaluator {
    ...
    public boolean evaluate(Object obj) {
        ...
        return DocListUnitStatus.CLOSED.getValueName().equals(vol.getStatus()) && StringUtils.equals(vol.getNode().getNodeRef().getStoreRef().toString(), "workspace://SpacesStore");
    }
}
