...
<h:panelGroup id="volume-search-panel-facets">
   <f:facet name="title">
      <h:panelGroup>
...
<a:panel id="volume-search-panel" facetsId="dialog:dialog-body:document-search-panel-facets" styleClass="panel-100" label="#{DialogManager.bean.filterPanelTitle}">
   <r:propertySheetGrid id="volume-search-filter" value="#{DialogManager.bean.filter}" columns="1" mode="edit" externalConfig="true"
...
<a:panel id="volume-search-filters-panel" styleClass="panel-100" label="#{DialogManager.bean.manageSavedBlockTitle}" rendered="#{DialogManager.bean.showManageSavedDialog}">
