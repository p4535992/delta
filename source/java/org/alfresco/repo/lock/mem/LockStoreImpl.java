...
/**
 * {@link org.alfresco.repo.lock.mem.LockStore} implementation backed by a Google {@link java.util.concurrent.ConcurrentMap}.
 * 
 * @author Matt Ward
 */
public class LockStoreImpl extends AbstractLockStore<ConcurrentMap<NodeRef, LockState>>
{
    ...
    {
        ConcurrentMap<NodeRef, LockState> map = CacheBuilder.newBuilder()
                .concurrencyLevel(32)
                .expireAfterWrite(expiry, timeUnit)
                .<NodeRef, LockState> build().asMap();
        return map;
    }
}
