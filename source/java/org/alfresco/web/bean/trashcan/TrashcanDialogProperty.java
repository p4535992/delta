...
public class TrashcanDialogProperty implements Serializable
{
    ...
    private String docTypeFilter = FILTER_TYPE_ALL;

    private String docTypeSearchText = null;
    ...
    public void setDocTypeSearchText(String docTypeSearchText) {
        this.docTypeSearchText = docTypeSearchText;
    }

    public String getDocTypeSearchText() {
    ...
    public String getObjectName() {        
        return (String) this.getItem().getProperties().get(ContentModel.PROP_ARCHIVED_OBJECT_NAME);
    }
