   ...
   protected void createTopic(final String id)
   {
      ...
      try
      {
         forumNodeRef = getTransactionService().getRetryingTransactionHelper().doInTransaction(
            ...
            MessageUtil.addErrorMessage(FacesContext.getCurrentInstance(), "forum_error_docLocked");
            ...
            MessageUtil.addErrorMessage(FacesContext.getCurrentInstance(), "forum_error_docDeleted");
            context.getApplication().getNavigationHandler().handleNavigation(context, null, AlfrescoNavigationHandler.CLOSE_DIALOG_OUTCOME+"[2]");
        } catch (Throwable e)
      {
