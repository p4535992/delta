...
REM SET JAVA_HOME=C:\Program Files\Java\jdk1.8.0_05
set PATH=%JAVA_HOME%\bin;%PATH%

:SetMaven2
REM # MAVEN 2
set M2_HOME=C:\My Programs\apache-maven-3.2.1
set PATH=%M2_HOME%\bin;%PATH%

REM set MAVEN_OPTS=-Xmx1024m

:SetGrails
SET GRAILS_HOME=C:\springsource\grails-2.4.0
set PATH=%GRAILS_HOME%\bin;%PATH%

:SetAnt
REM SET ANT_HOME=C:\My Programs\apache-ant-1.8.2
SET ANT_HOME=C:\My Programs\apache-ant-1.9.3
