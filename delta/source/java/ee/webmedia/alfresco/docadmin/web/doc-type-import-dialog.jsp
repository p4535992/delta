...
<%
   ...
   DocumentTypesImportDialog dialog = BeanHelper.getDocumentTypesImportDialog();
...
%>
      <a:panel styleClass="panel-100" id="file-upload" label="#{msg.upload_content}">
         <h:panelGrid id="upload_panel" columns="2" cellpadding="2" cellspacing="2" border="0" width="100%"
            ...
            <r:upload id="uploader" value="#{DocumentTypesImportDialog.fileName}" framework="dialog" />
         </h:panelGrid>
      </a:panel>
