...
<a:panel id="fieldDefDetails-panel" label="#{msg.field_details_panel}" styleClass="panel-100" progressive="true">
   ...
   <r:propertySheetGrid id="fieldDefDetailsPS" value="#{FieldDetailsDialog.field.node}" binding="#{FieldDetailsDialog.propertySheet}" columns="1" mode="edit" externalConfig="true" labelStyleClass="propertiesLabel" />
</a:panel>