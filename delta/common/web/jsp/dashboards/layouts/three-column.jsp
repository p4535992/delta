...
<%@ page import="org.alfresco.web.app.Application" %>
   ...
   <a:panel id="dash-layout-1st-col" styleClass="column panel-33">
   ...
   <a:panel id="dash-layout-2nd-col" styleClass="column panel-33">
   ...
   <a:panel id="dash-layout-3rd-col" styleClass="column panel-33-f">
