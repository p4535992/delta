...
public class UIDataPager extends UICommand
{
   ...
   public void encodeBegin(FacesContext context) throws IOException
   {
      ...
      String beginTag = "<span class='" + getAttributes().get("styleClass") + "-wrapper'><span";
      String endTag = "</span></span>";
      String divStyle = "";
      ...
      else
      {
         ...
         if (isIE)
         {
            beginTag = "<div class='" + getAttributes().get("styleClass") + "-wrapper'><div";
            endTag = "</div></div>";
   ...
   private void encodeType3(StringBuilder buf, int currentPage, int pageCount)
   {
