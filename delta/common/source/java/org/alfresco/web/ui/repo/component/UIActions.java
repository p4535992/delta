...
public class UIActions extends SelfRenderingComponent
{
   ...
   /**
    * Same as the previous method with this name, but takes it's ActionDefinition list by
    * invoking the specified method defined by "actionDefinitions".
    * @param context
    * @param contextId
    * @throws IOException
    */
   ...
   private void buildActionGroup(
        ...
        throws IOException
     {
        ...
        for (ActionDefinition actionDef : actionDefinitions)
        {
           if (actionDef == null)
           {
              throw new AlfrescoRuntimeException("Unable to find configured ActionDefinition");
           }
