...
, CustomAttributes
{
   ...
   // END: ComponentGenerator generator and CustomAttributes
   protected Map<String, String> propertySheetItemAttributes;

   /**
    * Moved up this method so that all PropertySheetItems could easily create IComponentGenerator with custom attributes
    * 
   ...
   @Override
   public final void setCustomAttributes(Map<String, String> propertySheetItemAttributes) {
