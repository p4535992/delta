...
public class InvalidNodeFixerBootstrap {
    ...
    private boolean newMaintenanceJobsEnabled = false;

    public boolean isNewMaintenanceJobsEnabled() {
        return newMaintenanceJobsEnabled;
    }

    public void setNewMaintenanceJobsEnabled(boolean newMaintenanceJobsEnabled) {
        this.newMaintenanceJobsEnabled = newMaintenanceJobsEnabled;
    }
