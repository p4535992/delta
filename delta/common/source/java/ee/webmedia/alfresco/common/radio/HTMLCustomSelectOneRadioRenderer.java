...
public class HTMLCustomSelectOneRadioRenderer extends Renderer {
    ...
    public void encodeEnd(FacesContext context, UIComponent component)
        ...
        if (component.isRendered()) {
            ...
            if (aUICustomSelectOneRadio.getDisabled() != null && aUICustomSelectOneRadio.getDisabled().trim().length() > 0
    ...
    private UIComponent getParentDataTableFromHierarchy(UIComponent uiComponent) {
        ...
        if (uiComponent instanceof UIData || uiComponent instanceof UIRichList) {
            return uiComponent;
        } else {
