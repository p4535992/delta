 ...
 * <ol>
 * <li>if input file does not have {@code ocr:ocrCompleted} aspect and file format is supported (currently only PDF), then file contents from repository are
 * passed to OCR program; otherwise file is ignored;</li>
