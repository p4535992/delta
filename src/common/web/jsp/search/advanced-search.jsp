         ...
         <a:panel id="content">
            ...
            <%@ include	file="../parts/breadcrumb.jsp"%>
                              ...
                              <a:panel id="titlebar">         
                                 ...
                                 <%-- Generally this consists of an icon, textual summary and actions for the current object --%>
                                 <h2>
                                    <h:graphicImage url="/images/icons/search_large.gif" width="32" height="32" />
                                    <h:outputText value="#{msg.advanced_search}" />
                                 </h2>
<%--
                                 <a:panel id="description">
                                    <h:outputText value="#{msg.advancedsearch_description}" />
                                 </a:panel>
 --%>
                                 ...
                                 <a:panel id="actions">
                                    <ul class="actions-menu extra-actions">
                                       <li>
                                         ...
                                         <a:modeList styleClass="dropdown-menu no-icon" itemSpacing="3" iconColumnWidth="0" style="text-align:right"
                                             selectedStyleClass="selected" disabledStyleClass="disabled" value="#{SearchProperties.savedSearchMode}"
                                             actionListener="#{AdvancedSearchDialog.savedSearchModeChanged}" menu="true" menuImage="/images/icons/arrow-down.png"
                                             label="#{msg.saved_searches}">
                                       ...
                                       <li>
                                          ...
                                          <h:selectOneMenu id="searches" value="#{SearchProperties.savedSearch}"
                                             onchange="document.forms['advsearch']['advsearch:act'].value='advsearch:show-search'; document.forms['advsearch'].submit(); return true;">
                                    ...
                                    <h:outputText value="#{msg.more_actions}: " styleClass="actions" />
                                    <ul class="actions-menu no-icon">
                                        <li>
                                          <a:actionLink value="#{msg.resetall}"  padding="2" actionListener="#{AdvancedSearchDialog.reset}" style="white-space:nowrap" />
                                       </li>
                                    </ul>
                                 </a:panel>
                              </a:panel>
                              ...
                              <%-- Details --%>
                              <a:panel id="advanced-search-field" styleClass="column panel-80" label="#{msg.look_for}">
                                 <h:inputText id="search-text" value="#{SearchProperties.text}" size="48" maxlength="1024" />
                              </a:panel>
                              
                              <a:panel id="search-actions" styleClass="column panel-20 container-buttons" >
                                      ...
                                      <a:panel id="adv-search-1st-col" styleClass="column panel-50">
                                       <a:panel label="#{msg.show_results_for}" id="restrict-panel" progressive="true"
                                       ...
                                       <a:panel label="#{msg.look_in}" id="location-panel" progressive="true"
                                       ...
                                       <a:panel label="#{msg.show_results_categories}" id="categories-panel" progressive="true"
                                       ...
                                       <a:panel id="adv-search-2nd-col" styleClass="column panel-50">
                                       <a:panel label="#{msg.also_search_results}" id="attrs-panel" progressive="true"
                                             ...
                                             <tr>
                                                <td>
                                                   <table cellpadding="0" cellspacing="2" border="0">
                                                      <tr>
                                                         <td><h:outputText value="#{msg.folder_type}" id="folderType" />:</td>
                                                         <td>
                                                      ...
                                                      <tr>
                                                         <td><h:outputText value="#{msg.content_type}" id="contentType" />:</td>
                                                         <td>
                                                      ...
                                                      <tr>
                                                         <td><h:outputText value="#{msg.content_format}" id="contentFormat" />:</td>
                                                         <td>
                                                      ...
                                                      <tr>
                                                         <td><h:outputText value="#{msg.title}" id="title" />:</td><td><h:inputText value="#{SearchProperties.title}" size="#{TextFieldGenerator.size}" maxlength="1024" id="txtTitle" /></td>
                                                      </tr>
                                                      <tr>
                                                         <td><h:outputText value="#{msg.description}" id="desc" />:</td><td><h:inputText value="#{SearchProperties.description}" size="#{TextFieldGenerator.size}" maxlength="1024" id="txtDesc" /></td>
                                                      </tr>
                                                      <tr>
                                                         <td><h:outputText value="#{msg.author}" id="author" />:</td><td><h:inputText value="#{SearchProperties.author}" size="#{TextFieldGenerator.size}" maxlength="1024" id="txtAuthor" /></td>
                                                      </tr>
                                                   </table>
                                                   <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                                   ...
                                                   <a:panel label="#{msg.additional_options}" id="custom-panel" styleClass="panel-90" progressive="true"
