...
import ee.webmedia.xtee.types.ee.riik.schemas.dhlMetaAutomatic.impl.DhlIdDocumentImpl;
import ee.webmedia.xtee.types.ee.riik.schemas.dhlMetaAutomatic.impl.DhlSaabumisaegDocumentImpl;
import ee.webmedia.xtee.types.ee.riik.schemas.dhlMetaAutomatic.impl.DhlSaatjaAsutuseNimiDocumentImpl;
import ee.webmedia.xtee.types.ee.riik.schemas.dhlMetaAutomatic.impl.DhlSaatjaAsutuseNrDocumentImpl;
import ee.webmedia.xtee.types.ee.riik.schemas.dhlMetaAutomatic.impl.DhlSaatjaEpostDocumentImpl;
import ee.webmedia.xtee.types.ee.riik.schemas.dhlMetaAutomatic.impl.DhlSaatmisaegDocumentImpl;
import ee.webmedia.xtee.types.ee.riik.schemas.dhlMetaManual.impl.KoostajaFailinimiDocumentImpl;
...
public interface DhlXTeeService {
    ...
    class DvkOrganizationsCacheingUpdateStrategy implements DvkOrganizationsUpdateStrategy {
        ...
        public boolean update4getDvkOrganizationsCache(Map<String, String> dvkCapableOrganizations) {
            ...
            return dvkCapableOrganizations == null || dvkCapableOrganizations.size() == 0 || lastUpdated == null || lastUpdated.before(cal);
        }
    ...
    class AnyTypeHelper {
        ...
        public AnyTypeHelper(XmlObject xmlObject) {
            subElementsList = parse(xmlObject);
        }
