...
<a:panel id="similar-results-panel" styleClass="panel-100" label="#{msg.document_search_similar_documents}" progressive="true" rendered="#{DocumentDialog.search.count > 0}">
