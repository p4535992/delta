...
$jQ(document).ready(function(){
   var inEditMode = </f:verbatim><h:outputText value="#{MetadataBlockBean.inEditMode}" id="varInEditMode" /><f:verbatim>;
   if(inEditMode){
      var clientLockRefreshFrequency = </f:verbatim><h:outputText value="#{MetadataBlockBean.clientLockRefreshFrequency}" id="varclientLockRefreshFrequency" /><f:verbatim>;
