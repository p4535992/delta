...
public class CreateForumNodeEvaluator extends BaseActionEvaluator {
    ...
    public boolean evaluate(Node node) {
        ...
        boolean isDiscussed = (node.hasAspect(ForumModel.ASPECT_DISCUSSABLE) == false);
        boolean isDocManager = userService.isDocumentManager();
        boolean isOwner = node.getProperties().get(DocumentCommonModel.Props.OWNER_ID).equals(userName);
